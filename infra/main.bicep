...
var resourceToken string = toLower(uniqueString(subscription().id, location))
var appName = 'func-${resourceToken}'
var deploymentStorageContainerName = 'app-package-${take(appName, 32)}-${take(resourceToken, 7)}'
var artifactUrl = 'https://github.com/Giancarl021/Meeting-Schedule/releases/latest/download/app.zip'
